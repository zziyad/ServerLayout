...
1. Source of truth is **artifacts/server2**.
2. Folder **artifacts/server** is deleted. Do not recreate it. Do not compare with GitHub unless asked to push.
...
Skill with the same rules: `nodejs-js-orchestrator` (`references/irreversible.md`).
